          ...
          <div class="row justify-content-center">
            <div class="col-lg-5 col-md-8 col-14 mx-auto">
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  <div class=" ">
                    <h5 class="card-title text-center text-success pb-0 fs-5 fw-bold">Créer un compte</h5>
                    <p class="text-center small"></p>
                  </div>

                    <div class="col-12 pt-3 mb-2" >
                        <label for="yourName" class="form-label"> Noms</label>
                        <input type="text" name="name" class="form-control" value="{{old('name')}}" id="yourName" required autofocus autocomplete="username" >
                        @error('name')
                    ...
                    <div class="col-12 pt-3 mb-2" >
                        ...
                        <input type="email" name="email" class="form-control" value="{{old('email')}}" id="yourEmail" required autofocus autocomplete="username" >
                        @error('email')
                            <div class="d-block text-danger">{{ $message }}</div>
                        @enderror
                    </div>
